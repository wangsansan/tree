...
public class BalanceTree2 {
	...
	public BalanceTree2(int[] values) {
	...
	public void deleteNode(Node node) {
		...
		if (father != null)
			if (node.getValue() > father.getValue()) {
				toDeleteNode = father.getRight();
				right = true;
				left = !right;
			} else {
				toDeleteNode = father.getLeft();
				left = true;
				right = !left;
			}
		else {
	...
	public static void main(String[] args) {
		...
		BalanceTree2 balanceTree = new BalanceTree2(values);
		balanceTree.deleteValue(16);
